...
return {
  ...
  -- The panel opens from the session listeners (settings/dap.lua) and from
  -- <leader>du; lazy.nvim loads it on the first require.
  spec("igorlfs/nvim-dap-view", "dap-view"),
  spec("theHamsta/nvim-dap-virtual-text", "dap-virtual-text"),
}
